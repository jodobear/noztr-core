...
async function main(): Promise<void> {
    ...
    results.push({
        ...
        depth: "BASELINE",
        result: "PASS",
        detail: "no dedicated nostr-tools NIP-92 helper; applesauce helper reviewed separately",
    });
    results.push({
        nip: "NIP-94",
        taxonomy: "LIB_UNSUPPORTED",
        depth: "BASELINE",
        result: "PASS",
        detail: "no dedicated nostr-tools NIP-94 helper; applesauce reviewed separately",
    });
    results.push({
        nip: "NIP-58",
        taxonomy: "LIB_UNSUPPORTED",
    ...
    results.push({
        ...
        depth: "BASELINE",
        result: "PASS",
        detail: "no dedicated nostr-tools NIP-26 helper",
    });
    results.push({
        nip: "NIP-37",
        taxonomy: "LIB_UNSUPPORTED",
        depth: "BASELINE",
        result: "PASS",
        detail: "no dedicated nostr-tools NIP-37 helper",
    });
    results.push({
        nip: "NIP-84",
        taxonomy: "LIB_UNSUPPORTED",
