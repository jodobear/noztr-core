...
pub fn poll_build_option_tag(
    output: *BuiltTag,
    option: PollOption,
) Nip88Error!nip01_event.EventTag {
...
fn validate_content(content: []const u8, allow_empty: bool) Nip88Error!void {
    std.debug.assert(limits.content_bytes_max > 0);
